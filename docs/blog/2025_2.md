...
The first dimension of fear is the fact that, with time, our societies became *risk-averse*. In some societies, the piling of regulations’ primary intent is to reduce the risks. This risk preoccupation became a *risk-phobia* in the last decades in the Western countries up to the point where some want to forbid entire activities, just because there are still risks attached to them.

AI comes as the "demon of the phobia": It brings tools which power and inexactitude creates a future full of new risks. The consequence is that risk-phobic people will struggle as much as they can to prevent AI to develop further. European laws to be applicable in 2026, with the "systemic" qualifier of AI LLMs, is a symbol of this risk-phobia extremism.

### Threatening the society equilibrium

The second dimension of this fear is that not being able to predict the future implies that the *current social order is threaten*.

Society, especially with its education system, structure the life of individuals. It guarantees a huge relationship between trainings, diplomas and jobs. Said differently, life paths, in society, are codified: There are several to choose from, most people take one of them (exceptional people may not). People follow paths that were carved by the society along the decades and centuries.

But, what if AI was creating a fundamental threat on all of that? What if suddenly any student could live without any professor? What if all the painful work done by individuals in one of the society carved path was done for nothing? What if suddenly, all this model was *obsolete*?

Obsolescence is one of the biggest fear, especially now that obsolescence touches intellectual professions.Those who could predict their future in their jobs a few years ago are now on the edge: What will happen if the society don't need me anymore?

The natural defense of individuals is to call to the State to maintain *order*: *please, protect us!* But, not only individuals want to be protected: groups of people sharing the same interests want to be protected. The call is then a bit distorted and could be understood as: *please, protect our privileges!*

### Threatening the learning to learn

More worrying: Who can predict the effects of AI on the learning of our children? While schools are supposed to *learn to learn*, AI seems to *learn to ask to get a reply*. That could deeply damage the relationship to knowledge and learning.
...
Driven by fear, anti-AI-development people are attacking BigAI on the following topics:

* AI is a bubble and we should not invest in it because the bubble will explode and many people will loose a lot of money.
* AI is dangerous because it is not accurate. Putting AI in every device is the threat for humanity survival.
* AI is owned by evil US companies that will manipulate people.
* AI should be regulated before it’s too late.
* Etc.

All those arguments hide the fears we have mentioned. They are not particularly strong, and they are not new:

AI is a bubble. OK and so what. The Internet bubble exploded but the Internet is still very much alive. OK people are placing bets on companies and many will loose big money. OK, isn’t it capitalism?
AI is not accurate. No it is not 100% reliable. But men are not neither. And that’s not because you read something in a book that it guarantees it to be true. For sure, AI is not IT, that was one of the first statement of this blog. So it is not accurate as IT is supposed to be. OK, it’s something new. And yes, this not 100% accuracy should be manipulated carefully when embedding AI into devices. But guys, we are manipulating chemicals every day but people are cautious. OK, we are talking about digital tools and that’s perhaps the novelty.
...
Concerning the AI regulation, the problem seems more complicated. Software is difficult to regulate$
