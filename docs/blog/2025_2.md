...
LLMs are frightening people because they are already better than us in plenty of domains. They know a lot more than we do (even if they’re not fully reliable), they accelerate many tasks, they answer questions, correct us, propose things and seem to enhance us.
...
If we look carefully at this fear, we can see it is rooted in one of the deepest human fears ever: *The impossibility to predict the future*.

Indeed, everyone agrees that AI is changing the world quickly, and that it will change the world probably even more in the future. But no one can predict if those changes are good or bad for humanity. As we have signs of both kinds of changes, people are divided between fear of AI being catastrophic for humanity, and AI being a booster for the same humanity.
...
AI comes as the *object of the phobia*: It brings powerful tools, not 100% reliable, and it creates a future full of new risks and uncertainties.

The consequence is that risk-phobic people feel compelled to struggle as much as they can to prevent AI to develop further. European laws to be applicable in 2026, for instance, by applying the concept of "systemic risk" to LLMs, is a symbol of this risk-phobia extremism.

### The threats to the society equilibriums
...
Obsolescence is one of the biggest fears, especially now that obsolescence touches intellectual professions, the white collars that were sure to be protected by their intellect. In a way, the society said to them they would be. And now what? Those who could predict their future in their jobs a few years ago are now on the edge: What will happen if the society don't need me anymore? If they are replace-able?

The natural defense of individuals is to call to the State to maintain *order*: *please, State, protect us!* But, not only individuals want to be protected: groups of people sharing the same interests want to be protected also. The call is then a bit distorted and could be understood as: *please, State, protect our privileges!*

Because, let's face it: some of us have privileges, and so, they have plenty of things to lose.

### Threatening the learning to learn

Well, adults are supposed to be grown-up people, but we can worry about the younger generations.

Who can predict the effects of AI on the learning of our children? While schools are supposed to *learn to learn*, AI seems to *learn to ask to get a reply*. That could deeply damage the relationship of children in construction to knowledge and learning. Will they learn? Is having a system that provides a response right now the best way to learn? Probably not.

Concerning this fear, who can anticipate what will be the consequences on children? The ones of us that were trained in the old system? Who can imagine accurately what is an AI-native generation? In what world will they be living? For sure, the AI-assisted future people will be different from us, but different how?

### "Fear is the mind-killer"

In the *Dune* novel, Franck Herbert warn us about fear and its capability of clouding our judgment.

Driven by fear, anti-AI-development people are attacking the AI ecosystem on the following topics:

* AI is a bubble and we should not invest in it because the bubble will explode and many people will lose a lot of money.
* AI is dangerous because it is not accurate. Putting AI in every device is the threat for humanity survival.
* AI is owned by evil US companies that will manipulate people providing biased answers.
* AI should be regulated before it’s too late. In the meanwhile, the development must stop.
* Etc.

All those arguments hide the fears we have mentioned. They are not particularly strong, and they are not new. Let's examine them in the same order as above:

* AI is a bubble. OK and so what? The Internet bubble exploded but the Internet is still very much alive. Sure, people are placing bets on companies and many will lose a lot of money. But isn’t it capitalism?
* AI is not accurate. No, it is not 100% reliable. But men are not neither. And that’s not because you read something in a book that it is true. For sure, AI is not IT, that was one of the first statement of this blog. So it is not accurate as IT is supposed to be. LLMs are something new, different. And for sure, the fact that AI systems are not 100% accurate should imply they should be used with caution when, for instance, being embedded into devices.
* You don’t need AI to lie to people. Just look at your media, what they say today of past events and what they used to say about it.
* Concerning the AI regulation, the problem seems more complicated. Software is difficult to regulate. We'll see with the European AI act what will be the result of this regulation a lot of European industrial companies would like to postpone (forever).

All those arguments are not great.

### Education in the hurricane

One of the pillars of our society is education. Education cultivates those various paths we were talking about, from childhood to manhood. In education, the signs of a big problem are here for 3 years and the arrival of ChatGPT in the student's lives.

Picture it: Professors create their subjects with LLMs, students respond with LLMs and professors make the corrections with a LLM. The result is that no-one learns anything anymore. That cannot work.

On the other hand, some professors are refusing any AI help in their domain and try to stick to the old methods and tools. That won't work either.

But let's face it: A PhD is generally mostly bibliography analysis and a small innovation. If LLMs can create PhD thesis, why spend so much time doing a PhD? An even if you have done one without AI, how will you prove you did and that you did better than your colleague that used a LLM for 99% of the work?

In a world based on competition, AI adoption seems inevitable.

### More antagonism

The fact is the LLMs are antagonizing people even more than they are today: All the persons that feel threatened will want to regulate, tax, forbid, break, prevent, etc. while all people benefiting from AI will want the exact opposite.

I already talked about the irruption of AI in the [religious domain](2025_1.md#bigai-is-a-punishment-from-god), but AI may also become a political topic quite soon, provided the technology can be stopped by regulation. Europe's extremism will be the world's lab in 2026.
