...
![title17-cover.jpg](../images/title17-cover.jpg)

The content wars in the age of Artificial Intelligence are escalating, transforming from battles over data rights to existential questions about the nature of truth, originality, and even human intellect.

The latest developments show a move toward mass-scale synthetic content generation and a complex legal tightrope walk around copyright, forcing us to reconsider our relationship with information itself.

## Elon Musk did dt: The Grokipedia experiment

The latest front in the content war is the battle for encyclopedic truth. Elon Musk's xAI recently launched *[Grokipedia](https://grokipedia.com)*, an AI-generated encyclopedia powered by the Grok chatbot, explicitly positioned as a more "truthful and independent alternative" to Wikipedia.

Not so long ago, he announced it (see [episode 1](006-BigAIToCleanTheWeb.md)). It's now done.
...
However, the situation is really crytal clear: **The [law of copyright](https://www.copyright.gov/title17) (Title 17) applies**.
...
* **AI Training Data:** Here also the situation is clear: *using copyrighted content to train an AI is a form of content usage.*
    * Creators (authors, artists, news agencies) must use a [license](017-TowardsANewLicensingModel.md) to distribute their content to the AI companies, and those companies have to pay for the content use in AI training.
